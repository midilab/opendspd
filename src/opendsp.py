...
class OpenDspCtrl:
    ...
    def __init__(self):
        # before we singleton shit this, lets make our daemon realtime 
    ...
    def start_audio(self):
        ...
        #self.__jack = subprocess.Popen(['/usr/bin/jackd', '-P63', '-r', '-p256', '-t3000', '-dalsa', '-dhw:CODEC', '-r48000', '-p64', '-n8', '-S', '-s', '-Xseq'])
        ...
        time.sleep(1)
        self.setRealtime(self.__jack.pid)
        time.sleep(2)
    ...
    def start_app(self, app_name):
        ...
        module = importlib.import_module('app.' + app_name)
